...
print("A new set of all elements that are 'in only one of the three sets Set1,Set2 and Set3' is:")
...
print("New set of elements that are 'exactly in two of the sets Set1, Set2 and Set3' is:")
print(set_final)
set_d={1,2}
set_d.clear()
for i in range(1,11):
...
print("New set of all Integers in the 'range 1 to 10' that are 'not in Set1' is:")
print(set_new)
set_e=set_d-set_uf
print("New set of all Integers in the range 1 to 10 that are not in Set1,Set2 and Set3.")
print(set_e)
